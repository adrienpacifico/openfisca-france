...
from openfisca_france.reforms.plf_2016 import suppression_decote_changement_bareme_trannoy_detricote
...
def test(year = 2015):
    ...
    count = 2
    people = 1
    reform = suppression_decote_changement_bareme_trannoy_detricote.build_reform(tax_benefit_system)
