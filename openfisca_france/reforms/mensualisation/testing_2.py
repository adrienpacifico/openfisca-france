...
simulation.calculate('iaidrdi_mensuel','2014-01')

simulation.calculate('iai_mensuel','2014-01')


simulation.calculate('irpp_mensuel','2014-01')


simulation.calculate_add('irpp_mensuel','2014')
simulation.calculate("irpp")

simulation.calculate("lambda_compensation")
...
print "ir_plaf_qf", simulation.calculate("ir_plaf_qf_mensuel_times_12", "2014-02")
print "ir_plaf_qf_add", simulation.calculate_add("ir_plaf_qf_mensuel_times_12")
...
simulation.calculate('sal_pen_net_mensuel_times_12', '2014-01')
...
print "irpp", simulation.calculate('irpp_mensuel',"2014-01")


print simulation.calculate("revdisp_mensuel", "2014-01")
